    ...
    useEffect(() => {
        ...
        class AutoDriver {
            ...
            constructor(
                mouse: MouseClass,
                manager: WebGLManager,
                opts: { enabled: boolean; speed: number; resumeDelay: number; rampDuration: number; alwaysAuto: boolean }
            ) {
                this.mouse = mouse;
                ...
                this.alwaysAuto = opts.alwaysAuto;
                this.pickNewTarget();
            }
            pickNewTarget() {
                const r = Math.random;
...
`;
        ...
        class WebGLManager implements LiquidEtherWebGL {
            ...
            constructor(props: any) {
                ...
                Mouse.onInteract = () => {
                    ...
                    if (this.autoDriver && !props.alwaysAuto) this.autoDriver.forceStop();
                };
    ...
    useEffect(() => {
        ...
        if (paused) {
            webgl.pause();
            if (webgl.autoDriver) webgl.autoDriver.forceStop();
    ...
    useEffect(() => {
        ...
        if (webgl.autoDriver) {
            ...
            webgl.autoDriver.alwaysAuto = alwaysAuto;
